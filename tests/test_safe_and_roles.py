...
from .utils import (local_node, local_node_reset, accounts, ETH_LOCAL_NODE_URL, hardhat_unlock_account, create_simple_safe, deploy_roles,
                    get_balance, steal_token, safe_send, setup_common_roles)
...
def test_balancer_aura_withdraw(local_node, accounts):
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_target_b_stETH_SP, signer_key=accounts[0].key)
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_function_approve_booster, signer_key=accounts[0].key)
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_target_booster, signer_key=accounts[0].key)
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_function_deposit, signer_key=accounts[0].key)
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_target_aura_pool, signer_key=accounts[0].key)
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_function_withdraw, signer_key=accounts[0].key)
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_target_weth, signer_key=accounts[0].key)
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_function_approve, signer_key=accounts[0].key)
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_target_vault_role1, signer_key=accounts[0].key)
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_function_join, signer_key=accounts[0].key)
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_target_vault_role4, signer_key=accounts[0].key)
    ...
    safe_send(safe, to=roles_ctract.address, data=scope_function_exit, signer_key=accounts[0].key)
