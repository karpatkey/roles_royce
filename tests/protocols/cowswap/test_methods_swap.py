...
from transaction_builder.protocols.cowswap.methods_swap import create_order_and_swap, swap
from transaction_builder.protocols.cowswap.utils import SwapKind, Order, quote_order_api
...
def test_create_order_and_swap(local_node_eth, requests_mock):
    ...
    transactables = create_order_and_swap(w3=w3,
                                          avatar=avatar_safe,
    ...
    assert transactables[
               1].data == ''
...
def test_swap(local_node_eth):
    ...
    assert transactables[
               1].data == ''
...
def test_integration_create_order_and_swap(local_node_eth, accounts, requests_mock):
    ...
    requests_mock.post("https://api.cow.fi/mainnet/api/v1/quote",
                       text=json.dumps({"quote": {"sellToken": "0xae7ab96520de3a18e5e111b5eaab095312d7fe84",
                                                  ...
                                                  "buyAmount": "4490141191271109775", "validTo": 1712786610,
                                                  "appData": "{\"appCode\":\"karpatkey_swap\"}",
                                                  "appDataHash": "0xec4d31696be1272dc6f998e7119a6776e55100c5f8a225ca4ff9529a9eef8e26",
                                                  "feeAmount": "5634924871531167", "kind": "sell",
                                                  "partiallyFillable": False, "sellTokenBalance": "erc20",
                                                  "buyTokenBalance": "erc20", "signingScheme": "presign"},
                                        "from": "0x01b1214ecf83ff63b12e18b05b3db84cae375635",
                                        "expiration": "2024-04-10T21:35:30.813459830Z", "id": 481431436,
                                        "verified": False}),
                       status_code=200)
    requests_mock.post("https://api.cow.fi/mainnet/api/v1/orders",
    ...
    tx_receipt = roles.send(txs=transactables,
                            role=role,
    ...
    for log in tx_receipt.logs:
        if log.address == '0x9008D19f58AAbD9eD0D60971565AA8510560ab41':
            ...
            break
    assert uid_from_tx_log == '0xf9524f70c501fa1d356de72d3b75c9aafb5eeebb771f1b01e04dfdbe8144a53501b1214ecf83ff63b12e18b05b3db84cae375635661791fa' or '0xf356250a165178a8128d943f1df212f696c17f4b4d306dd9891a1f66197157b601b1214ecf83ff63b12e18b05b3db84cae375635661791f9'
...
def test_integration_swap(local_node_eth, accounts, requests_mock):
    ...
    tx_receipt = roles.send(txs=sign_order_transactables,
                            role=role,
                            private_key=private_key,
                            roles_mod_address=roles_contract.address,
                            web3=w3)
    ...
    for log in tx_receipt.logs:
        if log.address == '0x9008D19f58AAbD9eD0D60971565AA8510560ab41':
            uid_from_tx_log = '0x' + log.data.hex()[194:len(log.data.hex()) - 16]
            break
    assert uid_from_tx_log == '0x6c9fbbe347d133956af1e2fcf0b1adede666faec6198cfecb96d9f292de2e60e01b1214ecf83ff63b12e18b05b3db84cae37563566178e12'
