...
def test_order():
    ...
    assert order.get_order_dict() == {
        "appData": "0xec4d31696be1272dc6f998e7119a6776e55100c5f8a225ca4ff9529a9eef8e26",
...
def test_quote_order_sell_buy(requests_mock):
        ...
        text=json.dumps(
            {
                ...
                "from": "0x458cd345b4c05e8df39d0a07220feb4ec19f5e6f",
                "expiration": "2024-04-10T04:35:10.557295381Z",
                "id": 480554155,
                "verified": False,
            }
        ),
    ...
    assert requests_mock.request_history[0].text == (
        '{"sellToken": "0x6B175474E89094C44Da98b954EedeAC495271d0F", "buyToken": '
...
def test_create_order_api(requests_mock):
    ...
    assert (
        response["UID"]
        == "0x1121a6e7fb9f3c50f962a996db730930d76b2c47af87c8c67dfde0ddb1ac5381458cd345b4c05e8df39d0a07220feb4ec19f5e6f6615c043"
    )
    assert requests_mock.request_history[0].text == (
        '{"sellToken": "0x6B175474E89094C44Da98b954EedeAC495271d0F", "buyToken": '
        '"0x6810e776880C02933D47DB1b9fc05908e5386b96", "receiver": '
