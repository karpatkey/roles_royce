...
def test_stake_in_gauge(local_node_eth):
    m = balancer.Stake(w3=local_node_eth.w3, gauge_address="0xb812249d60b80c7cbc9398e382ed6dfdf82e23d2", amount=100508265407679418)
...
def test_unstake_in_gauge(local_node_eth):
    m = balancer.Unstake(w3=local_node_eth.w3, gauge_address="0xb812249d60b80c7cbc9398e382ed6dfdf82e23d2", amount=35072783119882834679)
