...
def test_pool_assets(local_node_eth):
    w3 = local_node_eth.w3
    local_node_eth.set_block(block)
    assert Pool(w3=w3, pool_id=stable_pool_pid).assets() == ['0x5c6Ee304399DBdB9C8Ef030aB642B10820DB8F56',
 '0x616e8BfA43F920657B3497DBf40D6b1A02D4608d']
    assert Pool(w3=w3, pool_id=metastable_pool_pid).assets() == ['0xae78736Cd615f374D3085123A210448E74Fc6393',
 '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2']
    assert Pool(w3=w3, pool_id=composable_stable_pool_pid).assets() == ['0x42ED016F826165C2e5976fe5bC3df540C5aD0Af7',
 '0x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0',
 '0xac3E018457B222d93114458476f3E3416Abbe38F',
 '0xae78736Cd615f374D3085123A210448E74Fc6393']
    assert Pool(w3=w3, pool_id=weighted_pool_pid).assets() == ['0xba100000625a3754423978a60c9317c58a424e3D',
 '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2']
...
def test_pool_balances(local_node_eth):
    ...
    assert Pool(w3=w3, pool_id=metastable_pool_pid).pool_balances() == [13048741861807843211830, 15052548197564559927733]
    assert Pool(w3=w3, pool_id=composable_stable_pool_pid).pool_balances() == [2596148429267366902437064758664548,
 2173159551320492025528,
 9456532002425029275963,
 1585529541763709958508]
    assert Pool(w3=w3, pool_id=weighted_pool_pid).pool_balances() == [33299690445499735620931136, 16666117772307088233735]
