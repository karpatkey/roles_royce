...
def test_build_aura_positions(local_node_gc):
    with patch(
        ...
        assert result == [{'position_id': '226', 'position_id_tech': '0x750c5ED835d300d4ba5054cf2Fad946f0a0df0CD', 'position_id_human_readable': 'gnosis_Aura_WETH_wstETH', 'protocol': 'Aura', 'exec_config': 
                           [{'function_name': 'exit_1', 'label': 'Unstake', 'test': True, 'description': 'Unstake BPT from Aura gauge', 'parameters': 
                             [{'name': 'rewards_address', 'type': 'constant', 'value': '0x750c5ED835d300d4ba5054cf2Fad946f0a0df0CD'}]}, 
...
def test_build_balancer_positions(local_node_gc):
    with patch(
        ...
        assert result == [{'protocol': 'Balancer', 'position_id': '226', 'position_id_tech': '0xF48f01DCB2CbB3ee1f6AaB0e742c2D3941039d56', 
