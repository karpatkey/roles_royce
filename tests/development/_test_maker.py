...
def test_maker_cdp_module_proxy():
    ...
    # send gem approval
    send_approve_gem = roles.send([approve_gem], role=1, private_key=accounts[1].key,
    ...
    send_lock_gem = roles.send([lock_gem], role=1, private_key=accounts[1].key,
                                roles_mod_address=roles_ctract.address,
                                web3=w3)
    ...
    send_draw_dai = roles.send([draw_dai], role=1, private_key=accounts[1].key,
                                roles_mod_address=roles_ctract.address,
                                web3=w3)
    ...
    send_approve_dai = roles.send([approve_dai], role=1, private_key=accounts[1].key,
                                roles_mod_address=roles_ctract.address,
                                web3=w3)
    ...
    send_wipe_dai = roles.send([wipe_dai], role=1, private_key=accounts[1].key,
                                roles_mod_address=roles_ctract.address,
                                web3=w3)
    dai_balance = get_balance(w3=w3, token=ETHAddr.DAI, address=safe.address)
    ...
    send_free_gem = roles.send([free_gem], role=1, private_key=accounts[1].key,
                                roles_mod_address=roles_ctract.address,
                                web3=w3)
    locked_gem = vat_contract.functions.urns(ilk, urn_handler).call()[0]
    assert locked_gem == 0
