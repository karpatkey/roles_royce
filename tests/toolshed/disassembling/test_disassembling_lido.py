...
def test_integration_exit_3(local_node_eth, accounts, requests_mock):
        ...
        text=json.dumps(
            {
                ...
                "expiration": "2024-04-12T00:31:32.753094749Z",
                "id": 482551545,
                "verified": False,
            }
        ),
    ...
    assert (
        uid_from_tx_log
        == "0x1d49609e1f36a65f7b0993728ef5661dffd89a1ac2dbfbe7a8641a95a504d32a17efb5661e7582f247fbce3693b1f7158acb98146618876d"
    )
...
def test_integration_exit_4(local_node_eth, accounts, requests_mock):
    ...
    assert (
        uid_from_tx_log
        == "0xad195ee894e0aca6bff6faeff78d452e5890f8c918a57bcdf382f234ecdef01c17efb5661e7582f247fbce3693b1f7158acb98146618876d"
    )
