...
def test_get_token_transfers(web3_eth, web3_gnosis):
    ...
    assert message == ('  Address 0x65389F6FFe361C0C27Ea5D9691616a2060f8a167 received 0.055 WETH '
    ...
    assert message == ('  Address 0x458cD345B4C05e8DF39d0A07220feb4Ec19F5e6f transferred 28623.230 '
                       'DXS to address 0xD7b118271B1B7d26C9e044Fc927CA31DccB22a5a.\n'
                       '\n'
