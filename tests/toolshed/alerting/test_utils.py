from roles_royce.toolshed.alerting.utils import get_token_amounts_from_transfer_event, get_tx_executed_msg
...
def test_get_token_transfers(web3_eth, web3_gnosis):
    ...
    transfers, message = get_token_amounts_from_transfer_event(tx_receipt, ETHAddr.WETH,
    ...
    transfers, message = get_token_amounts_from_transfer_event(tx_receipt, '0x9C58BAcC331c9aa871AFD802DB6379a98e80CEdb',
