...
class SwapWXDAIforEURe(ContractMethod):
    ...
    target_address = AddressesAndAbis[Chains.Gnosis].DepositZap.address
...
class SwapsDataManager:
    ...
    def get_EURe_to_WXDAI_curve(self, amount: float) -> float:
        ...
        """
        contract = self.w3.eth.contract(address=AddressesAndAbis[Chains.Gnosis].DepositZap.address,
                                        abi=AddressesAndAbis[Chains.Gnosis].DepositZap.abi)
    ...
    def get_EUR_oracle_price(self):
        ...
        contract = self.w3.eth.contract(address=AddressesAndAbis[Chains.Gnosis].ChainlinkFeed.address,
                                        abi=AddressesAndAbis[Chains.Gnosis].ChainlinkFeed.abi)
