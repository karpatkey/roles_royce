...
def main():
    ...
    strategies_gnosis_ltd_ethereum = DAOStrategiesBuilder(DAO.GnosisLTD,
                                                          ...
                                                          balancer=[BalancerPosition(position_id="123",
                                                                                     bpt_address=BalancerContractSpecs[Chains.Ethereum].BPT_COW_WETH.address),
    ...
    strategies_gnosis_ltd_gnosis_chain = DAOStrategiesBuilder(DAO.GnosisLTD,
                                                              ...
                                                              aura=[AuraPosition(position_id="244",
                                                                                 bpt_address='0x2086f52651837600180de173b09470f54ef74910')])
    ...
    strategies_gnosis_dao_ethereum = DAOStrategiesBuilder(DAO.GnosisDAO,
                                                          ...
                                                          aura=[AuraPosition(position_id="33",
                                                                ...
                                                                AuraPosition(position_id="35",
                                                                             bpt_address='0x3dd0843a028c86e0b760b1a76929d1c5ef93a2dd'),
                                                                AuraPosition(position_id="38",
                                                                             bpt_address='0x92762b42a06dcdddc5b7362cfb01e631c4d44b40'),
                                                                AuraPosition(position_id="40",
    ...
    strategies_gnosis_dao_gnosis_chain = DAOStrategiesBuilder(DAO.GnosisDAO,
                                                              ...
                                                              balancer=[BalancerPosition(position_id="107",
                                                                        ...
                                                                        BalancerPosition(position_id="108",
                                                                                         bpt_address='0x388cae2f7d3704c937313d990298ba67d70a3709'),
                                                                        BalancerPosition(position_id="167",
                                                                                         bpt_address='0xbad20c15a773bf03ab973302f61fabcea5101f0a'),
                                                                        BalancerPosition(position_id="205",
                                                                                         bpt_address='0x5519e2d8a0af0944ea639c6dbad69a174de3ecf8'),
                                                                        BalancerPosition(position_id="237",
                                                                                         bpt_address='0x2086f52651837600180de173b09470f54ef74910'),
                                                                        BalancerPosition(position_id="238",
                                                                                         bpt_address='0xeb30c85cc528537f5350cf5684ce6a4538e13394'),
                                                                        BalancerPosition(position_id="245",
                                                                                         bpt_address='0x4683e340a8049261057d5ab1b29c8d840e75695e'),
                                                                        BalancerPosition(position_id="247",
                                                                                         bpt_address='0x00df7f58e1cf932ebe5f54de5970fb2bdf0ef06d'),
                                                                        BalancerPosition(position_id="249",
                                                                                         bpt_address='0x0c1b9ce6bf6c01f587c2ee98b0ef4b20c6648753'),
                                                                        BalancerPosition(position_id="251",
                                                                                         bpt_address='0x4cdabe9e07ca393943acfb9286bbbd0d0a310ff6'),
                                                                        BalancerPosition(position_id="276",
                                                                                         bpt_address='0xbc2acf5e821c5c9f8667a36bb1131dad26ed64f9'),
                                                                        BalancerPosition(position_id="320",
                                                                                         bpt_address='0x7644fa5d0ea14fcf3e813fdf93ca9544f8567655'),
                                                                        BalancerPosition(position_id="323",
                                                                                         bpt_address='0x06135a9ae830476d3a941bae9010b63732a055f4')],
                                                              aura=[AuraPosition(position_id="275",
                                                                                 bpt_address='0xdd439304a77f54b1f7854751ac1169b279591ef7'),
                                                                    AuraPosition(position_id="225",
                                                                                 bpt_address='0x21d4c792ea7e38e0d0819c2011a2b1cb7252bd99'),
                                                                    AuraPosition(position_id="231",
                                                                                 bpt_address='0xbad20c15a773bf03ab973302f61fabcea5101f0a')])
