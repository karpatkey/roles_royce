...
def update_dynamic_data(w3_eth: Web3, w3_gnosis: Web3, static_data: StaticData) -> DynamicData:
    bridge_DAI_balance = erc20_contract(w3=w3_eth, address=EthereumTokenAddr.DAI).functions.balanceOf(
        ContractSpecs[Chain.ETHEREUM].xDaiBridge.address).call()
    ...
    return DynamicData(bridge_DAI_balance=bridge_DAI_balance,
