...
class ENV:
    ...
    def __post_init__(self):
        ...
        if self.TEST_MODE:
            ...
            self.RPC_ENDPOINT_ETHEREUM_FALLBACK = f"http://{self.LOCAL_FORK_HOST_ETHEREUM}:{self.LOCAL_FORK_PORT_ETHEREUM}"
            self.RPC_ENDPOINT_ETHEREUM_EXECUTION = f"http://{self.LOCAL_FORK_HOST_ETHEREUM}:{self.LOCAL_FORK_PORT_ETHEREUM}"
            ...
            self.RPC_ENDPOINT_ETHEREUM_EXECUTION = custom_config("RPC_ENDPOINT_ETHEREUM_EXECUTION", default="",
                                                                 cast=str)
        ...
        if self.PRIVATE_KEY != "":
            ...
            fork_unlock_account(w3=Web3(Web3.HTTPProvider(f'http://{self.LOCAL_FORK_HOST_ETHEREUM}:'
                                                          f'{self.LOCAL_FORK_PORT_ETHEREUM}')),
