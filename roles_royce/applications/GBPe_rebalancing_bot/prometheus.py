...
class Gauges:
    ...
    drift_in_spot_price = Gauge("drift_in_spot_price", "Drift in spot price")
    ...
    def update(self, static_data: StaticData, dynamic_data: DynamicData):
        ...
        self.GBPe_price_curve.set(dynamic_data.GBPe_spot_price)
        ...
        self.drift_in_spot_price.set(dynamic_data.drift_in_spot_price)
