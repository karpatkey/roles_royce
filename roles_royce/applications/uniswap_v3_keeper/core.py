...
class ENV:
    ...
    ROLE: int = config("ROLE", default="", cast=int)
    ...
    FEE: FeeAmount = config("FEE", default=str(3000), cast=int)
    ...
    MINIMUM_MIN_PRICE: float = config("MINIMUM_MIN_PRICE", default='', cast=float)
