...
class SingleSwap(ContractMethod):
    ...
    Attributes:
        target_address : (Address) The address of the smart contract to be interacted with.
    ...
    def __init__(self,
        ...
        Args:
            ...
            swap_kind : (SwapKind) An instance of SwapKind, representing the type of the swap.
...
class ExactTokenInSingleSwap(SingleSwap):
    ...
    Attributes:
        ...
        token_in_address : (Address) An instance of Address, representing the address of the input token.
        token_out_address : (Address) An instance of Address, representing the address of the output token.
        amount_in : (int) An integer representing the exact amount of the input token.
        min_amount_out : (int) An integer representing the minimum amount of the output token to be received.
    """
...
class ExactTokenOutSingleSwap(SingleSwap):
    ...
    Attributes:
        ...
        token_in_address : (Address) An instance of Address, representing the address of the input token.
        token_out_address : (Address) An instance of Address, representing the address of the output token.
        amount_out : (int) An integer representing the exact amount of the output token.
        max_amount_in : (int) An integer representing the maximum amount of the input token to be used.
    """
