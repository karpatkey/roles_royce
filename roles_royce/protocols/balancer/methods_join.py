...
class _ExactBptSingleTokenJoin(Join):
  ...
  This class is a subclass of Join.

  Attributes
  ----------
  user_data_abi : list[str]
      The ABI of the user data.
  join_kind : StablePoolJoinKind
      The kind of join.

  Methods
  -------
  __init__(blockchain, pool_id, avatar, assets, max_amounts_in, bpt_amount_out, join_token_index)
      The constructor for the _ExactBptSingleTokenJoin class.
  """
  ...
  def __init__(self,
      ...
      max_amounts_in : list[int]
          A list of maximum amounts of each token to be sent by the user.
      bpt_amount_out : int
          The amount of BPT to be minted.
      join_token_index : int
          The index of the token to enter the pool.
      """
...
class ExactBptSingleTokenJoin(_ExactBptSingleTokenJoin):
  ...
  This class is a subclass of _ExactBptSingleTokenJoin.
  ...
  token_in_address : Address
      The address of the token to be sent by the user.
  max_amount_in : int
      The maximum amount of token to be sent by the user.
  assets : list[Address]
      A list of addresses of the assets.

  Methods
  -------
  __init__(w3, pool_id, avatar, bpt_amount_out, token_in_address, max_amount_in, assets=None)
      The constructor for the ExactBptSingleTokenJoin class.
  """
...
class _ProportionalJoin(Join):
  ...
  Methods
  -------
  __init__(blockchain, pool_id, avatar, assets, bpt_amount_out, max_amounts_in)
      The constructor for the _ProportionalJoin class.
  """
...
class _ExactTokensJoin(Join):
  ...
  Methods
  -------
  __init__(blockchain, pool_id, avatar, assets, amounts_in, min_bpt_amount_out)
      The constructor for the _ExactTokensJoin class.
  """
  ...
  def __init__(self,
      ...
      assets : list[Address]
          A list of addresses of the assets.
      amounts_in : list[int]
          A list of precise amounts of each token to be sent by the user.
      min_bpt_amount_out : int
          The minimum amount of BPT to be minted.
      """
...
class ExactTokensJoin(_ExactTokensJoin):
  ...
  A class representing an exact tokens join where the user sends precise quantities of tokens, 
  and receives an estimated but unknown (computed at run time) quantity of BPT.
  This class is a subclass of _ExactTokensJoin.
  ...
  Methods
  -------
  __init__(w3, pool_id, avatar, amounts_in, min_bpt_amount_out, assets=None)
      The constructor for the ExactTokensJoin class.
  """
...
class ExactSingleTokenJoin(_ExactTokensJoin):
  ...
  token_in_address : Address
      The address of the token to be sent by the user.
  amount_in : int
      The precise amount of token to be sent by the user.
  min_bpt_amount_out : int
      The minimum amount of BPT to be minted.
  assets : list[Address]
      A list of addresses of the assets.
  ...
  Methods
  -------
  __init__(w3, pool_id, avatar, token_in_address, amount_in, min_bpt_amount_out, assets=None)
      The constructor for the ExactSingleTokenJoin class.
  """
...
class QueryJoinMixin:
  ...
  out_signature : list[tuple]
      The output signature for the query join.

  Methods
  -------
  __init__()
      The constructor for the QueryJoinMixin class.
  """
...
class ExactBptSingleTokenQueryJoin(QueryJoinMixin, ExactBptSingleTokenJoin):
  ...
  and receives an estimated but unknown (computed at run time) quantity of BPT.
  This class is a subclass of QueryJoinMixin and ExactBptSingleTokenJoin.
  ...
  Methods
  -------
  __init__(w3, pool_id, bpt_amount_out, token_in_address)
      The constructor for the ExactBptSingleTokenQueryJoin class.
  """
...
class ProportionalQueryJoin(QueryJoinMixin, ProportionalJoin):
  ...
  Methods
  -------
  __init__(w3, pool_id, bpt_amount_out, assets=None)
      The constructor for the ProportionalQueryJoin class.
  """
...
class ExactTokensQueryJoin(QueryJoinMixin, ExactTokensJoin):
  ...
  and receives an estimated but unknown (computed at run time) quantity of BPT.
  This class is a subclass of QueryJoinMixin and ExactTokensJoin.
  ...
  Methods
  -------
  __init__(w3, pool_id, amounts_in)
      The constructor for the ExactTokensQueryJoin class.
  """
...
class ExactSingleTokenQueryJoin(QueryJoinMixin, ExactSingleTokenJoin):
  ...
  A class representing a query for an exact single token join where the user sends a precise quantity of a single token, 
  and receives an estimated but unknown (computed at run time) quantity of BPT.
  This class is a subclass of QueryJoinMixin and ExactSingleTokenJoin.
  ...
  Methods
  -------
  __init__(w3, pool_id, token_in_address, amount_in)
      The constructor for the ExactSingleTokenQueryJoin class.
  """
...
class ExactBptSingleTokenJoinSlippage(ExactBptSingleTokenJoin):
  ...
  This class is a subclass of ExactBptSingleTokenJoin.
  ...
  token_in_address : Address
      The address of the token to be sent by the user.
  max_slippage : float
      The maximum slippage allowed for the transaction.
  assets : list[Address], optional
      A list of addresses of the assets. If not provided, it will be fetched from the pool.

  Methods
  -------
  __init__(w3, pool_id, avatar, bpt_amount_out, token_in_address, max_slippage, assets=None)
      The constructor for the ExactBptSingleTokenJoinSlippage class.
  """
...
class ExactSingleTokenJoinSlippage(ExactSingleTokenJoin):
 ...
 token_in_address : Address
    An instance of Address, representing the address of the token to be joined.
 amount_in : int
    An integer representing the amount of token to be joined.
 max_slippage : float
    A float representing the maximum slippage allowed for the join operation.
 assets : list[Address], optional
    A list of Address instances, representing the assets in the pool. This is optional and if not provided, the assets are fetched from the pool.

 Methods
 -------
 __init__(w3, pool_id, avatar, token_in_address, amount_in, max_slippage, assets=None)
    The constructor for the ExactSingleTokenJoinSlippage class.
 """
...
class ExactBptProportionalJoinSlippage(ProportionalJoin):
 ...
 avatar : Address
   An instance of Address, representing the avatar of the pool.
 bpt_amount_out : int
   An integer representing the amount of BPT to be minted.
 max_slippage : float
   A float representing the maximum slippage allowed for the join operation.

 Methods
 -------
 __init__(w3, pool_id, avatar, bpt_amount_out, max_slippage)
   The constructor for the ExactBptProportionalJoinSlippage class.
 """
...
class ExactTokensJoinSlippage(ExactTokensJoin):
 ...
 avatar : Address
   An instance of Address, representing the avatar of the pool.
 amounts_in : list[int]
   A list of integers representing the amounts of tokens to be joined.
 max_slippage : float
   A float representing the maximum slippage allowed for the join operation.

 Methods
 -------
 __init__(w3, pool_id, avatar, amounts_in, max_slippage)
   The constructor for the ExactTokensJoinSlippage class.
 """
...
class ExactSingleTokenProportionalJoinSlippage(ExactTokensJoin):
 ...
 -------
 __init__(w3, pool_id, avatar, token_in_address, amount_in, max_slippage, assets=None)
   The constructor for the ExactSingleTokenProportionalJoinSlippage class.
 """
