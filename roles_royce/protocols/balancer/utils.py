...
class Pool:
    ...
    Attributes:
        w3 : (Web3) An instance of Web3, representing the blockchain network.
        pool_id : (str) A string representing the ID of the pool.
        vault_contract : (Contract) An instance of Contract, representing the vault contract in the blockchain network.
        bpt_contract : (Contract) An instance of Contract, representing the BPT contract in the blockchain network.
    """
    ...
    def pool_kind(self) -> PoolKind:
        ...
        Returns:
        PoolKind An instance of PoolKind, representing the kind of the pool.
        """
    ...
    def assets(self) -> list[str]:
        ...
        Returns:
        (list[str]) A list of strings, representing the assets of the pool.
        """
    ...
    def pool_balances(self) -> list[int]:
        ...
        Returns:
        (list[int]) A list of integers, representing the token balances of the pool.
        """
    ...
    def bpt_index_from_composable(self) -> int:
        ...
        Returns:
        (int) An integer representing the BPT index of the pool.
        """
