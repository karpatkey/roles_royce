...
class DelegationTarget():
    targets = [ContractSpecs[Chain.ETHEREUM].variableDebtWETH.address,
...
class DepositETH(ContractMethod):
    ...
    fixed_arguments = {"address": ContractSpecs[Chain.ETHEREUM].LendingPoolV3.address, "on_behalf_of": AvatarAddress, "referral_code": 0}
