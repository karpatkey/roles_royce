...
class DepositCollateral(WithdrawCollateral):
...
class MintDAI(WithdrawCollateral):
    """mint DAI to borrow"""
    name = "draw"
...
class PayBackAndWithdrawCol(WithdrawCollateral):
    """be free"""
    ...
    def __init__(self, adapter: Address, dai_join: Address, cdp_vault: int, amount: int):
        super().__init__(adapter, cdp_vault, amount)
