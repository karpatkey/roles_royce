...
class Mint(ContractMethod):
    ...
    def __init__(self,
        ...
        self.args.params = [self.args.token0, self.args.token1, self.args.fee, self.args.tick_lower, 
                            self.args.tick_upper, self.args.amount0_desired,self.args. amount1_desired,
                            self.args. amount0_min, self.args.amount1_min, self.fixed_arguments["recipient"], 
                            self.args.deadline]
...
class IncreaseLiquidity(ContractMethod):
    ...
    def __init__(self,
        ...
        self.args.amount1_min = amount1_min
        self.args.deadline = deadline
        self.args.params = [self.args.token_id, self.args.amount0_desired, self.args.amount1_desired, 
                            self.args. amount0_min, self.args.amount1_min, self.args.deadline]
...
class DecreaseLiquidity(ContractMethod):
    ...
    def __init__(self,
        ...
        self.args.amount1_min = amount1_min
        self.args.deadline = deadline
        self.args.params = [self.args.token_id, self.args. amount0_min, self.args.amount1_min, self.args.deadline]
...
class Collect(ContractMethod):
    ...
    def __init__(self,
        ...
        self.args.params = [self.args.token_id, self.args.recipient, self.args.amount0_max, self.args.amount1_max]
...
class SweepToken(ContractMethod):
    ...
    name = "sweepToken"
    in_signature = [("token", "address"), ("amount_minimum", "uint256"), ("recipient", "address")]
    fixed_arguments = {"recipient": AvatarAddress}
