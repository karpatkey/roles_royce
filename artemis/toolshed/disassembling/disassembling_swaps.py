...
from artemis.protocols.balancer.methods_general import ApproveForVault
from artemis.protocols.balancer.methods_swap import ExactTokenInSingleSwap, QuerySwap, SingleSwap
from artemis.protocols.balancer.types_and_enums import SwapKind
from artemis.protocols.base import Address
from artemis.protocols import cowswap
from artemis.protocols.swap_pools.quote_methods import QuoteCurve, QuoteUniswapV3
from artemis.protocols.swap_pools.swap_methods import (
    ApproveCurve,
    ApproveUniswapV3,
    SwapCurve,
    SwapUniswapV3,
...
from artemis.toolshed.disassembling.disassembler import Disassembler, validate_percentage
